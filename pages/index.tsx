...
const index = () => {
  return (
    <motion.div className="flex flex-col px-6 pt-1 flex-grow" variants={routeAnimation} initial="hidden" animate="show" exit="exit">
      <h5 className="my-3 font-medium">Collaborative computer science student with fundamental knowledge of web and software development. Eager to secure an internship/work position utilizing excellent analytical and programming abilities, and my experience with building web applications.</h5>
